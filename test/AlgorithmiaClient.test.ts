...
describe("Localisation initialization", () => {
    ...
    describe('algorithm get call', () => {
        it('gets for algorithm', async () => {
            const algorithm: Algorithm = JSON.parse(await Algorithmia.getClient(process.env.ALGORITHMIA_DEFAULT_API_KEY).getAlgo('dherring', 'ResultFile'));
    ...
    describe('algorithm versions list call', () => {
        it('gets for algorithm versions list', async () => {
            const algorithmVersionsList: AlgorithmVersionsList = JSON.parse(await Algorithmia.getClient(process.env.ALGORITHMIA_DEFAULT_API_KEY).listAlgoVersions('dherring', 'ResultFile'));
    ...
    describe('algorithm builds list call', () => {
        it('gets for algorithm builds list', async () => {
            const algorithmBuildsList: AlgorithmBuildsList = JSON.parse(await Algorithmia.getClient(process.env.ALGORITHMIA_DEFAULT_API_KEY).listAlgoBuilds('dherring', 'ResultFile'));
    ...
    describe('algorithm builds log call', () => {
        it('gets for algorithm build logs', async () => {
            const response: [] = JSON.parse(await Algorithmia.getClient(process.env.ALGORITHMIA_DEFAULT_API_KEY).getAlgoBuildLogs('dherring', 'ResultFile', '579ff0a8-6b1f-4cf4-83a5-c7cb6999ae24'));
    ...
    describe('algorithm create call', () => {
        it('creates for algorithm', async () => {
            const testAlgo = Algorithm.prototype.createTestAlgo();
            const algorithm: Algorithm = JSON.parse(await Algorithmia.getClient(process.env.ALGORITHMIA_DEFAULT_API_KEY).createAlgo('dherring', testAlgo));
    ...
    describe('algorithm list scms call', () => {
        it('lists scms', async () => {
            const response: SCM[] = JSON.parse(await Algorithmia.getClient(process.env.ALGORITHMIA_DEFAULT_API_KEY).listSCMs());
    ...
    describe('algorithm get scm call', () => {
        it('gets an scm', async () => {
            const scm: SCM = JSON.parse(await Algorithmia.getClient(process.env.ALGORITHMIA_DEFAULT_API_KEY).getSCM('internal'));
