var Data, Dir, DirListing, File, exports,
...
DirListing = (function() {
  ...
  DirListing.prototype.iterator = function() {
    return {
      next: (function(_this) {
        return function(cb) {
          var d, dl, f, fl, nextResult, ref, ref1;
          if (_this.error) {
            ...
            dl = ((ref = _this.page.folders) != null ? ref.length : void 0) || 0;
            fl = ((ref1 = _this.page.files) != null ? ref1.length : void 0) || 0;
            if (_this.offset < dl) {
              d = _this.page.folders[_this.offset];
              _this.offset++;
              cb(null, new Dir(_this.client, 'data://' + _this.data_path + '/' + d.name));
            } else if (_this.offset < dl + fl) {
              f = _this.page.files[_this.offset];
              _this.offset++;
              nextResult = new File(_this.client, 'data://' + _this.data_path + '/' + f.filename);
